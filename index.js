  ...
  for (i = 0; i < 3; i++) {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `[ *WELCOME IN Cuk GC ${mdata.subject}* ] \n___________________________\n@${num.split('@')[0]} Intro/Dikick!!! \n𝐍𝐚𝐦𝐚 : \n𝐔𝐦𝐮𝐫 : \n𝐀𝐬𝐤𝐨𝐭 : \n𝐆𝐞𝐧𝐝𝐞𝐫 : \n𝐔𝐝𝐚𝐡 𝐏𝐮𝐧𝐲𝐚 𝐃𝐨𝐢/𝐁𝐥𝐦?: \n𝐏𝐚𝐩 𝐌𝐮𝐤𝐚 𝐃𝐮𝐥𝐮!!! \n𝐍𝐚𝐦𝐚 𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦? \n𝐒𝐚𝐯𝐞 𝐍𝐨𝐦𝐨𝐫 𝐀𝐃𝐌𝐈𝐍! \n *___________________________*\nSemoga betah Di group!! dan semoga dapat pacar`
				...
				teks = `SELAMAT TINGGAL... @${num.split('@')[0]}👋* \n_Kalo balik nitip gorengan um dan semoga arwah mu tidak gentayangan semoga tenang disana_`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["6283843251769@s.whatsapp.net"] // Ganti pake nomor lu
			const ramlanNumber = ["6283843251769@s.whatsapp.net"] // JANGAN DI UBAH NGENTOD
			...
			switch(command) {
               ...
               client.sendMessage(from, 'Nih nomor bos besar, ehh ownerku hehee😁 jangan di galakin ya:*',MessageType.text, { quoted: mek} )
                break
				case 'ocr':
				...
				case 'tts':
					...
					ranm = getRandom('.mp3')
					dtt.length > 600
					? reply('Textnya kebanyakan jancuk🤬')
