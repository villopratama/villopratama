...
const config = {
    A187: '🐼villopratama🐼', // TOBAT SU ASU
    instagram: 'www.instagram.com/villosmile_', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6283843251769', // INFO SU JNGAN DI UBAH
    youtube: 'https://youtube.com/channel/villo smile', // KINTIL
    whatsapp: 'https://https://wa.me/qr/CBONDIDGJ5SFO1', // BABI
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready, subscribe villo musical`)
})
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["https://wa.me/qr/CBONDIDGJ5SFO1"] // ganti nomer lu
...
break
       ...
       client.sendMessage(from, '𝗧𝘂𝗵 𝗱𝗮𝗵 𝗮𝗸𝘂 𝗸𝗮𝘀𝗶𝗵 𝗻𝗼𝗺𝗲𝗿 𝗖𝗢 🐼villopratama🐼,𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗗𝗜 𝗦𝗔𝗩𝗘 𝗘𝗔 ><',MessageType.text, { quoted: mek} )
           break    
           case 'demote':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
